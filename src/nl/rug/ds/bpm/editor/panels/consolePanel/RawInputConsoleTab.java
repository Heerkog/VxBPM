 ...
 */
public class RawInputConsoleTab extends AbstractKripkeConsoleTab<RawInputConsoleTab.StructureConsoleTab> {

    public RawInputConsoleTab() {
        super();
    }
    ...
    public class  StructureConsoleTab implements IJPanel {
        ...
        public StructureConsoleTab(int structureId){
            ...
            EventSource.addListener(EventType.CONSOLE_RAWINPUT, (e) -> {
        ...
        private void getKripkeModelString(){
            ...
            try {
                textArea.setText(structure.getRawInput());
            } catch (Exception ex) {
                ex.printStackTrace();
            }
        }
